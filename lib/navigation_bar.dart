...
class _ViewModel {
  ...
  _ViewModel({@required this.bottomNavigationBarSelectedIndex, @required this.onTap});
  ...
  factory _ViewModel.create(Store<AppState> store) {
    ...
    return _ViewModel(bottomNavigationBarSelectedIndex: store.state.bottomNavigationBarSelectedIndex, onTap: _onTap);
  }
}